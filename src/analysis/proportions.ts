...
const LIPS_STANDARDS: StandardsMap = {
  ...
  symmetryIndex: {
    female: { min: 0.85, max: 1.0, center: 0.93 },
    male:   { min: 0.85, max: 1.0, center: 0.93 },
    unisex: { min: 0.85, max: 1.0, center: 0.93 },
    label: 'Симметрия губ',
    unit: '',
    description: 'Насколько совпадают правая и левая половины губ. 1.0 — идеальная симметрия.',
    howToRead: 'Чем ближе к 1.0, тем симметричнее губы. Ниже 0.85 — заметная разница между правой и левой стороной.',
    whyImportant: 'Симметрия — один из самых заметных факторов гармонии лица. Даже небольшую асимметрию губ глаз замечает в первую очередь, и она хорошо корректируется филлером.',
    tolerance: 0.05,
  },
};
